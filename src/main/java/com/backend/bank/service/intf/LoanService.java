...
public interface LoanService {
    ...
    LoanApplicationResponse approveLoan(LoanApprovalRequest request)
            throws LoanNotFoundException, InvalidLoanStatusException, AccountNotExistException;

    LoanRepaymentResponse makeRepayment(LoanRepaymentRequest request)
            throws LoanNotFoundException, InvalidRepaymentAmountException, InsufficientFundsException,
            AccountNotExistException;

    LoanDetailsResponse getLoanDetails(Long loanId)
            throws LoanNotFoundException;

    List<LoanDetailsResponse> getCustomerLoans(Long customerId)
            throws CustomerNotFoundException;
}
